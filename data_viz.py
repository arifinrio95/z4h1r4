...
class DataViz():
    ...
    def visualization(self):
        ...
        with tab4:      
            ...
            valid_integer_cols_for_line = [col for col in self.integer_cols if df[col].nunique() > 20]
            valid_date_cols_for_line = [col for col in self.date_cols if df[col].nunique() > 20]
