...
def request_story_prompt(dict_stats):
    messages = [
        ...
        {"role": "user", "content": f"""Buatkan laporan insights atau kesimpulan berbentuk paragraf narasi yang mudah dipahami manusia dari data berikut:  {dict_stats}. Jika ada pesan error, skip saja tidak usah dijelaskan. Tidak usah dijelaskan bahwa kamu membaca dari dictionary."""}
    ]
